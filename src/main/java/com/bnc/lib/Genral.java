...
public class Genral extends Global {	
	...
	public void quikResrvationWithExistingCompany() throws InterruptedException {
		...
		WebElement salesperson = driver.findElement(By.className("ant-select-selection__placeholder"));// click on sales person																										
		...
		WebElement toggle = driver.findElement(
				By.xpath("//*[@id='ReservationListForm']/div/div[1]/div[8]/div[3]/div/div[2]/div/span/span/span/i"));// click on company toggle																														
		toggle.click();
		Thread.sleep(1000);
	...
	public void quickReservationWithnewCompany() throws InterruptedException {
		...
		String getorgname = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/div/div[1]/div[2]/table/tbody/tr[1]/td[7]/div/span[1]")).getText();
		
		Assert.assertEquals(org, getorgname);
		
		System.out.println("Quick Reservation added successfully");
	...
	public void editQuickReservation() throws InterruptedException{
		...
		WebElement update=driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/button[3]"));
		update.click();
	...
	public void deleteQuickReservation() throws InterruptedException{
		...
		WebElement deleteButton = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr[1]/td/div/button[2]/div/i"));
		deleteButton.click();
		
		WebElement reason = driver.findElement(By.id("reason"));
		reason.sendKeys("Not Required");
		
		WebElement popUpDeletebutton = driver.findElement(By.xpath("/html/body/div[2]/div/div[2]/div/div[1]/div[3]/div/button[2]"));																	
	...
	public void filterInQuickRes() throws InterruptedException{
		...
		WebElement filterIcon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/div/div[1]/div[1]/table/thead/tr/th[2]/span/i"));
		filterIcon.click();
		
		WebElement filterSearch = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[2]/div/div/div/div/input"));
		String res_id="4751370";
		filterSearch.sendKeys(res_id);
		
		WebElement searchInFilter = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[2]/div/div/div/div/div/button[1]"));
		searchInFilter.click();
		
		String idText = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/div/div[1]/div[2]/table/tbody/tr/td[2]")).getText();
	...
	public void searchInQuickRes() throws InterruptedException{
		...
		WebElement searchicon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/div/div[1]/div[1]/table/thead/tr/th[7]/span/i"));
		searchicon.click();
		
		WebElement searchTexBox= driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[3]/div/div/div/div/input"));
		String searchText ="walkin";
		searchTexBox.sendKeys(searchText);
		
		WebElement searchButton =driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[3]/div/div/div/div/button[1]"));
		searchButton.click();
		
		String resultCompany = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div/div/div[1]/div/div/div/div[1]/div[2]/table/tbody/tr[1]/td[7]/div/span[1]")).getText();
	...
	public void addReservation() throws InterruptedException{
		...
		WebElement customer = driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[2]/div[1]/div/div[1]/div[2]/div/div[2]/div/span/div/div/div"));
		customer.click();
		...
		WebElement event = driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[2]/div[1]/div/div[1]/div[3]/div/div[2]/div/span/div/div/div"));
		event.click();		
		...
		WebElement status=driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[2]/div[1]/div/div[3]/div[1]/div/div[2]/div/span/div/div/div"));//click on status
		status.click();		
		...
		WebElement salesPerson = driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[2]/div[1]/div/div[3]/div[2]/div/div[2]/div/span/div/div/div"));
		salesPerson.click();
		
		WebElement selectsalesperson = driver.findElement(By.xpath("/html/body/div[9]/div/div/div/ul/li[3]"));
		selectsalesperson.click();
		
		WebElement areatab =driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[1]/div[2]/div/div/div/div[3]/span"));
		areatab.click();
		
		Thread.sleep(1000);
		
		WebElement addArea= driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[2]/div[2]/div/div/div/div/div/div[1]/div[1]/div[2]/button"));
		...
		WebElement selectFirstArea = driver.findElement(By.xpath("/html/body/div[10]/div/div[2]/div/div/div[2]/form/div/div/div[3]/div[1]/div/div/div/div/div[2]/table/tbody/tr[1]/td[5]/button"));
		selectFirstArea.click();
		
		Thread.sleep(1000);
		
		WebElement selectSecondArea = driver.findElement(By.xpath("/html/body/div[10]/div/div[2]/div/div/div[2]/form/div/div/div[3]/div[1]/div/div/div/div/div[2]/table/tbody/tr[2]/td[5]/button"));
		...
		WebElement clickOnPage = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[1]/div/div[1]"));
		clickOnPage.click();
		
		Thread.sleep(1000);
		
		WebElement saveButton = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/button[2]"));
		saveButton.click();
	...
	public void reservationIdFillter() throws InterruptedException{
		...
		WebElement filtericon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[1]/div[1]/table/thead/tr/th[2]/span/i"));
		filtericon.click();
		
		Thread.sleep(1000);
		
		String resid="4489219";
		WebElement enterSearchId = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[2]/div/div/div/div/input"));
		enterSearchId.sendKeys(resid);
		
		Thread.sleep(1000);
		
		WebElement searchicon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[2]/div/div/div/div/div/button[1]"));
		searchicon.click();
		
		Thread.sleep(1000);
		
		String filteredId = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[1]/div[2]/table/tbody/tr/td[2]")).getText();
	...
	//change organization name
		public void reservationSearch() throws InterruptedException{
			...
			WebElement searchIcon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[1]/div[1]/table/thead/tr/th[7]/span/i"));
			searchIcon.click();
			
			Thread.sleep(1000);
			
			String orgname="walkin";
			WebElement enterOrgname = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[3]/div/div/div/div/input"));
			enterOrgname.sendKeys(orgname);
			
			Thread.sleep(1000);
			
			WebElement searchicon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[3]/div/div/div/div/button[1]"));
			searchicon.click();
			
			Thread.sleep(1000);
			
			String searchOrgRes = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[1]/div[2]/table/tbody/tr/td[7]/div/span[1]")).getText();
		...
		public void reservationEdit() throws InterruptedException{
			...
			WebElement selectSecondarea = driver.findElement(By.xpath("//*[@id='ReservationListForm']/div/div[2]/div[2]/div/div/div/div/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div/div[1]/a"));
			selectSecondarea.click();
			...
			WebElement updateButton = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/button[3]"));
			updateButton.click();
	...
	public void fpAndChallans() throws InterruptedException{
		...
		WebElement ongoingradioBtn = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[1]/div/label[3]/span[1]/input"));
		ongoingradioBtn.click();
		
		Thread.sleep(2000);

		/*List<WebElement> ongoingList = driver.findElements(By.xpath(
				"//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr/td/div/button[1]"));//ongoing list
		System.out.println("show size" + ongoingList.size());
		
		for (int i = 1; i <= ongoingList.size(); i++) {*/	
			
			//WebElement editButton = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr["+i+"]/td/div/button[1]"));
			WebElement editButton =driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr[1]/td/div/button[1]"));
			editButton.click();
			...
			WebElement saveChallanNumber = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div/div[1]/div/div[2]/button[1]"));
	...
	public void proformaGeneration() throws InterruptedException{
		...
		WebElement ongoingradioButton = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[1]/div/label[3]/span[1]/input"));
		Actions actions = new Actions(driver);
	...
	public void discount() throws InterruptedException{
		...
		WebElement viewClick = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr[1]/td/div/button[1]"));
		viewClick.click();
		...
		WebElement savebutton = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/div/button[1]"));
		savebutton.click();	
	...
	public void invoiceSplit() throws InterruptedException{
		...
		WebElement invoiceradioBtn= driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[1]/div[1]/div/label[2]/span[1]/input"));
		invoiceradioBtn.click();
		
		Thread.sleep(1000);		
		
		/*WebElement orgFilter = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[1]/div[1]/table/thead/tr/th[4]/span/i"));
		orgFilter.click();
		
		Thread.sleep(1000);
		
		WebElement orgsearch = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[4]/div/div/div/div/input"));
		orgsearch.click();
		
		Thread.sleep(1000);
		
		WebElement searchIcon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[4]/div/div/div/div/div/button[1]"));
		searchIcon.click();
		
		Thread.sleep(1000);
		
		WebElement searchField = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[4]/div/div/div/div/input"));
		searchField.sendKeys("M/s JDA Software");
		
		Thread.sleep(1000);*/		
		
		WebElement viewIcon = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[1]/div/div/div/div[2]/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr/td/div/button[1]"));
		viewIcon.click();
		...
		WebElement splitSave = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/div/button[2]"));
		splitSave.click();		
	...
	public void payments() throws InterruptedException{
		...
		//String getInvoiceNum = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div[4]/div[1]/div/div[3]")).getText();
		...
		WebElement selectBank =driver.findElement(By.xpath("//*[@id='Cheque']/div[2]/div[2]/div/span/div/div/div/div"));
		...
		WebElement payNowbtn= driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[1]/div/div[2]/div/div/button[3]"));
		payNowbtn.click();
	...
	public void voidInvoice() throws InterruptedException{
		...
		WebElement voidBtn = driver.findElement(By.xpath("//*[@id='app']/div/div/div[2]/div[2]/div/div[2]/div[3]/div/div[1]/div[2]/div[2]/div/span/button"));
		voidBtn.click();
		
		Thread.sleep(1000);
		
		WebElement selectVoidtype = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div/div[2]/div/div[1]/div/div[2]/div/span/div/div/div/div[1]"));
		Actions actions = new Actions(driver);
		...
		WebElement tickIcon = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div[2]/div/div[1]/div/div[2]/button[1]"));														  
